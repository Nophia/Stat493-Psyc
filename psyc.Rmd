...
data1<-data%>%
  mutate(isolation_reverse_scored=isolation_reverse_scored+1, self_judgment_reverse_scored=self_judgment_reverse_scored+1, over_identification_reverse_scored=over_identification_reverse_scored+1)%>%
...
```{r}
model1 <- lm(depression ~ group + age + anxious_attachment + avoidant_attachment + isolation_reverse_scored + over_identification_reverse_scored + anxiety , data = psyc.train)
...
```{r}
model2 <- lm(depression ~ group + age + anxious_attachment + avoidant_attachment + isolation_reverse_scored + over_identification_reverse_scored + anxiety , data = psyc.train1)
summary(model2)
